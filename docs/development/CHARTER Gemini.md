...
**Versie:** 0.6 — Architectuur, AI-Transitie en Meetbaarheid geactualiseerd, originele tekst hersteld
...
**De belofte in één zin:** *Wij maken jouw data zo eerlijk leesbaar dat je er beslissingen op durft te baseren — zonder twijfel over wiens belang er gediend wordt.*
...
**Hoe we dit kwantificeren zonder engagement-tracking:**

We meten succes via een vrijwillige, privacy-vriendelijke *'Inzicht-ping'*. Wanneer een gebruiker een analyse als waardevol ervaart, kan hij dit met één klik markeren. Dit is de enige kwalitatieve interactiemetric die we verzamelen.
...
**Wat we wél meten:** Groeit het zelfbegrip van de gebruiker over tijd? Worden er verbanden zichtbaar die daarvoor onzichtbaar waren? Blijft hij omdat het platform hem iets geeft — niet omdat hij vastzit?
...
**Laag 4 — Creator economy (platformfee op sovereign subscriptions)** Creators die hun publiek een betaalde laag aanbieden via het platform (data-verrijkte werkprocessen, diepere dagboeken, procesverslagen) dragen een kleine platformfee af. Minimaal, transparant, en creators bezitten hun eigen publiek volledig — geen lock-in.
...
| 0.5 | 2026-03-08 | Architectuur (Centrale DB ipv Local First) en BYOAI Transitie besproken |
| 0.6 | 2026-03-08 | Samenvoeging van 0.4 teksten en 0.5 concepten |
